...
const sections = [
  {
    ...
    items: [
      "Политика обработки персональных данных в ООО «КАВКАЗ-ИНЖИРИНГ» (далее – Политика) разработана на основании Федерального закона от 27.07.2006 № 152-ФЗ «О персональных данных» в целях обеспечения защиты прав и свобод субъектов персональных данных.",
      "Целью Политики является установление основных принципов, условий и подходов к обработке и обеспечению безопасности персональных данных при их обработке ООО «КАВКАЗ-ИНЖИРИНГ».",
      "ООО «КАВКАЗ-ИНЖИРИНГ», являясь Оператором, обеспечивает защиту прав и свобод субъектов при обработке их персональных данных и принимает меры для выполнения обязанностей, предусмотренных Федеральным законом № 152-ФЗ и принятыми в соответствии с ним нормативно-правовыми актами.",
      "Настоящая Политика действует в отношении всех процессов ООО «КАВКАЗ-ИНЖИРИНГ», связанных с обработкой персональных данных, и распространяется на отношения в области обработки персональных данных, возникшие как до, так и после её утверждения.",
      ...
      "Настоящая Политика обязательна для ознакомления и исполнения всеми лицами, допущенными к обработке персональных данных ООО «КАВКАЗ-ИНЖИРИНГ».",
    ],
  },
  {
    id: "terms",
  ...
  },
  {
    ...
    list: [
      ...
      "Договоры, заключаемые между ООО «КАВКАЗ-ИНЖИРИНГ» и субъектами персональных данных или контрагентами.",
    ],
  },
  {
    id: "celi",
  ...
  },
  {
    ...
    items: [
      "Ответственным за пересмотр настоящей Политики является ООО «КАВКАЗ-ИНЖИРИНГ».",
  ...
  },
  {
    ...
    items: [
      "ООО «КАВКАЗ-ИНЖИРИНГ» (ОГРН 1252600004249) использует cookie — небольшие текстовые файлы, размещаемые на устройстве пользователя для персонализации сервисов и анализа использования сайта.",
          ...
          <div className="container relative">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-foreground/85 leading-relaxed max-w-2xl">
                Политика обработки персональных данных в ООО «КАВКАЗ-ИНЖИРИНГ», разработанная в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных».
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container grid lg:grid-cols-12 gap-12 items-start">
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-foreground/85 text-lg leading-relaxed">
                Настоящая Политика устанавливает основные принципы, условия и подходы к обработке и обеспечению безопасности персональных данных в ООО «КАВКАЗ-ИНЖИРИНГ».
              </p>
