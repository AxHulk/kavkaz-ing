...
const documents = [
  {
    ...
    description:
      "Документ содержит перечень мероприятий, направленных на улучшение условий и охраны труда работников ООО «КАВКАЗ-ИНЖИРИНГ».",
          ...
          <div className="container relative">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-foreground/85 leading-relaxed max-w-2xl">
                В соответствии с Федеральным законом № 426-ФЗ публикуем результаты специальной оценки условий труда (СОУТ) на рабочих местах ООО «КАВКАЗ-ИНЖИРИНГ».
              </p>
            </div>
          </div>
        </section>
