      ...
      <div className="container">
        <div className="max-w-4xl mb-16 text-center mx-auto">
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed mb-5">
            ООО «КАВКАЗ-ИНЖИРИНГ» — единый центр инжиниринговых компетенций, который оказывает полный комплекс организационных, координационных, административных и инженерно-технических услуг. Весь цикл строительного инжиниринга: от документации до мониторинга.
          </p>
